<script setup lang="ts">
  ...
  import IconLogo from '@/shared/assets/icons/IconLogo.vue';
...
<template>
  <header class="fixed top-0 left-1/2 transform -translate-x-1/2 w-full max-w-[430px] z-20 bg-background">
    ...
    <!-- полоска -->
    <div class="h-px bg-primary-foreground"></div>
  </header>
</template>
